    ...
    <div className="flex flex-col lg:flex-row min-h-screen">
      ...
      <section className="w-full lg:w-1/2 px-10 py-20 xl:px-16 flex flex-col gap-16 overflow-y-auto">
        ...
        <div className="flex flex-col gap-6">
          ...
          <h1 className="text-2xl xl:text-2xl font-bold tracking-tight text-zinc-900 dark:text-zinc-50 leading-tight opacity-75">
            Arranca tu proyecto
            <br />
            con todo lo que necesitas
          </h1>
          <p className="text-base text-zinc-500 dark:text-zinc-400 leading-relaxed max-w-md">
            Crea proyectos Next.js, React+Vite y Astro con las integraciones que
            elijas, configuradas y listas para usar.
          </p>
  ...
  return (
    <div className="flex flex-col gap-3 p-6 min-h-[320px] justify-center font-mono text-sm">
      ...
      <div className="pl-4 flex flex-col gap-1 text-zinc-400 mt-1">
        <div>
          <span className="text-green-400">▶</span> Crear nuevo proyecto
        </div>
      ...
      <div className="pl-4 flex flex-col gap-1 text-zinc-400 mt-2">
        ...
        <div>
          ...
          <span className="text-green-400">React Query</span>
        </div>
        <div>
          <span className="text-green-400 text-xs">[✓]</span>{" "}
        ...
        <div>
          ...
          <span className="text-zinc-400">NextAuth v5</span>
        </div>
      </div>
    </div>
  );
